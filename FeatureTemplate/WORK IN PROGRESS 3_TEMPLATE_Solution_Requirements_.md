...
| ------------- |:-------------|
| Требования к отчетности   | Текст требования |
| Сертификационные требования   | Текст требования |
| Административные функции   | Текст требования |
| Уровни авторизации    | Текст требования |
| Отслеживание аудита   | Текст требования |
| Внешние интерфейсы    | Текст требования |
| Управление данными   | Текст требования |
| Правовые и нормативные требования | Текст требования |
