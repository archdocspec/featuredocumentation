...
|------------|--------------------------------|----------------------------------------------------------------|-------------------------------------------|-----------------------------------------|-------------------------------------|
| Предусловие  | UC1 | Пользователь переходит в раздел “Смартфоны” Пользователь авторизовался и залогинился, вошел в категорию Установка параметров товара  | Нет    | ![Начало](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/pre-requirement.png)    | Мокумент ссылка на доку |
