...
| номер шага | Имя Шага | соотвествующий UC | Описание шага | Действие в UI| Макет| Вызов/Процедура|
|:------------:|------------|-----------------|----------------------------------------------------------------|-------------------------------------------|-----------------------------------------|-------------------------------------|
| Предусловие  | Просмотр товаров | UC1  | Пользователь переходит в раздел “Смартфоны” Пользователь авторизовался и залогинился, вошел в категорию Установка параметров товара  | Нет    | ![Начало](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/pre-requirement.png)    | Мокумент ссылка на доку |
| 1    |  Добавление товара в корзину | UC2.1| Пользователь добавляет выбранный товар в корзину. | Нажмите кнопку “В корзину”. | * ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/to_cart.png) * ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/to_cart2.png) | Нет |
| 2 | Переход в корзину | UC2.1 | Пользователь переходит в раздел “Корзина”. | Нажмите на “Корзина”. | ![Переход в корзину](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/cartbutton.png) | Нет    |
| 3 | Просмотр добавленных товаров | UC2.2 | Пользователь ознакомляется с добавленными товарами и их ценами. | Просмотрите список товаров в корзине| ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/select_amount.png) | Нет    |
| 4 | Изменение количества товаров | UC2.2 | Пользователь устанавливает нужное количество для каждого товара. | Введите количество в соответствующие поля | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/Layout/All_scens/%D0%BA%D0%BE%D1%80%D0%B7%D0%B8%D0%BD%D0%B0%20%D0%B5%D1%81%D0%BB%D0%B8%20%D0%B2%D1%8B%D0%B1%D1%80%D0%B0%D1%82%D1%8C%20%D0%B2%D1%81%D1%91.png) | Нет    |
| 5 | Удаление товара | UC2.2 | Пользователь удаляет ненужные товары из корзины (при необходимости). | Нажмите кнопку “Удалить”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/deleteposition.png) | Нет    |
| 6 | Выбор всех товаров | UC2.2 | Пользователь выбирает все товары для оформления заказа (при необходимости). | Нажмите кнопку “Выбрать всё” | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/selectall.png) | Нет    |
| 7 | Проверка итоговой суммы | UC2 | Пользователь ознакомляется с итоговой суммой заказа.    | Проверьте поле “Итого”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/totalpricecheck.png) | Нет    |
| 8 | Оформление заказа | UC2 | Пользователь переходит к оформлению заказа. | Нажмите кнопку “Оформить заказ”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/placeorder.png) | Нет    |
| 9 | Ввод и проверка данных клиента | UC2.3 | Пользователь может ввести свои данные для совершения заказа | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/Layout/All_scens/%D0%BA%D1%83%D1%80%D1%8C%D0%B5%D1%80%D0%BE%D0%BC%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5.png) |
| 10 | Оплата заказа | UC2.4 | Пользователь выбрать нужный тип оплаты и произвести её для завершения заказа | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/Layout/All_scens/%D0%BA%D1%83%D1%80%D1%8C%D0%B5%D1%80%D0%BE%D0%BC%20%D1%81%D1%82%D0%B0%D1%80%D1%8B%D0%B5%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5.png) |
| 11 | Подтверждение оформления заказа | UC2.4 | Магазин выводит экран подтверждения оформления заказа.   | Просмотрите экран подтверждения | ![Подтверждение заказа](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/orderconfirmed.png) | Нет    |
| 12 | Передача заказа курьеру | UC2.5 | Заказ передается курьеру для доставки. | Действие на стороне магазина | Нет | Нет |
| Завершение | Получение заказа | UC2.5 | Клиент успешно получает заказ |  Действие на стороне доставки и клиента | Нет | Мокумент ссылка на доку      |
...
![Activity Diagram S1](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/scenactivity.png)
...
:(1) UC2.1 Добавление товара в корзину;
:(2) UC2.1 Переход в корзину;

fork
    :(3) UC2.1 Просмотр добавленных товаров;
fork again
    :(4) UC2.1 Изменение количества товаров;
fork again
    :(5) UC2.1 Удаление товара;
fork again
    :(6) UC2 Выбор всех товаров;
fork again
    :(7) UC2 Проверка итоговой суммы;
end fork
:(8) UC2 Оформление заказа;
:(9) UC2.3 Ввод и проверка данных клиента;
:(10) UC2.4 Оплата заказа;
:(11) UC2.4 Магазин выводит экран подтверждения оформления заказа;
:(12) UC2.5 Заказ передается курьеру для доставки;
:Завершение 
 UC2.5 Заказ передается курьеру для доставки;
stop
@enduml
