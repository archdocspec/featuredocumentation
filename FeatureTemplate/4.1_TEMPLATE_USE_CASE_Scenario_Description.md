...
| номер шага | Имя Шага и соотвествующий UC | Описание шага | Действие в UI| Макет| Вызов/Процедура|
|------------|--------------------------------|----------------------------------------------------------------|-------------------------------------------|-----------------------------------------|-------------------------------------|
...
| 2 | UC2.1 Переход в корзину | Пользователь переходит в раздел “Корзина”. | Нажмите на “Корзина”. | ![Переход в корзину](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/cartbutton.png) | Нет    |
| 3 | UC2.1 Просмотр добавленных товаров    | Пользователь ознакомляется с добавленными товарами и их ценами. | Просмотрите список товаров в корзине| ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/select_amount.png) | Нет    |
| 4 | UC2.1 Изменение количества товаров    | Пользователь устанавливает нужное количество для каждого товара. | Введите количество в соответствующие поля | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/Layout/All_scens/%D0%BA%D0%BE%D1%80%D0%B7%D0%B8%D0%BD%D0%B0%20%D0%B5%D1%81%D0%BB%D0%B8%20%D0%B2%D1%8B%D0%B1%D1%80%D0%B0%D1%82%D1%8C%20%D0%B2%D1%81%D1%91.png) | Нет    |
| 5 | UC2.1 Удаление товара | Пользователь удаляет ненужные товары из корзины (при необходимости). | Нажмите кнопку “Удалить”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/deleteposition.png) | Нет    |
| 6 | UC2 Выбор всех товаров | Пользователь выбирает все товары для оформления заказа (при необходимости). | Нажмите кнопку “Выбрать всё” | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/selectall.png) | Нет    |
| 7 | UC2 Проверка итоговой суммы  | Пользователь ознакомляется с итоговой суммой заказа.    | Проверьте поле “Итого”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/totalpricecheck.png) | Нет    |
| 8 | UC2 Оформление заказа | Пользователь переходит к оформлению заказа. | Нажмите кнопку “Оформить заказ”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/placeorder.png) | Нет    |
...
| 10 | UC2.4 | Оплата заказа | Пользователь выбрать нужный тип оплаты и произвести её для завершения заказа | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/Layout/All_scens/%D0%BA%D1%83%D1%80%D1%8C%D0%B5%D1%80%D0%BE%D0%BC%20%D1%81%D1%82%D0%B0%D1%80%D1%8B%D0%B5%20%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D0%B5.png) |
| 11 |  UC2.4 Подтверждение оформления заказа | Магазин выводит экран подтверждения оформления заказа.   | Просмотрите экран подтверждения | ![Подтверждение заказа](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/orderconfirmed.png) | Нет    |
| 12 | UC2.5 Передача заказа курьеру | Заказ передается курьеру для доставки. | Действие на стороне магазина | Нет | Нет |
| Завершение | UC2.5 Получение заказа | Клиент успешно получает заказ |  Действие на стороне доставки и клиента | Нет | Мокумент ссылка на доку      |
