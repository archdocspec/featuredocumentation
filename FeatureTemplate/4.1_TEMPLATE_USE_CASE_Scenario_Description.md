...
| 4    | Просмотр добавленных товаров    | Пользователь ознакомляется с добавленными товарами и их ценами. | Просмотрите список товаров в корзине| ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/select_amount.png) | Нет    |
...
| 6   | Удаление товара | Пользователь удаляет ненужные товары из корзины (при необходимости). | Нажмите кнопку “Удалить”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/deleteposition.png) | Нет    |
| 7   | Выбор всех товаров | Пользователь выбирает все товары для оформления заказа (при необходимости). | Нажмите кнопку “Выбрать всё” | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/selectall.png) | Нет    |
| 8   | Проверка итоговой суммы  | Пользователь ознакомляется с итоговой суммой заказа.    | Проверьте поле “Итого”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/totalpricecheck.png) | Нет    |
| 9   | Оформление заказа | Пользователь переходит к оформлению заказа. | Нажмите кнопку “Оформить заказ”. | ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/placeorder.png) | Нет    |
