...
| номер шага | Имя Шага | соотвествующий UC | Действие в UI| Макет| Вызов/Процедура|
|:------------:|------------|-----------------|----------------------------------------------------------------|-------------------------------------------|-------------------------------------|
| Предусловие  | Просмотр товаров | UC1  | Пользователь переходит в раздел “Смартфоны” Пользователь авторизовался и залогинился, вошел в категорию Установка параметров товара  | ![Начало](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/pre-requirement.png)    | Мокумент ссылка на доку |
...
| 2 | Переход в корзину | UC2.1 | Нажмите на “Корзина” Пользователь переходит в раздел “Корзина”. | ![Переход в корзину](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/cartbutton.png) | Нет    |
| 3 | Просмотр добавленных товаров | UC2.2 | Просмотрите список товаров в корзине Пользователь ознакомляется с добавленными товарами и их ценами.| ![Макет](https://github.com/archdocspec/featuredocumentation/blob/main/FeatureTemplate/Assets/S1/select_amount.png) | Нет    |
