...
>[!TIP]
>Заполните таблицу с общим списком требований
...
| Автоматизация обработки данных | Система должна автоматически обрабатывать входящие данные, что позволит сократить время выполнения задач на 30%. |
