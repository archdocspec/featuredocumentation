...
| Поле | Тип данных | Размерность | Пример значения | Описание |
|------|------------|-------------|-----------------|----------|
| uid* | varchar | 10 | “U001” | Уникальный идентификатор пользователя |
| userid | int | - | 123 | Идентификатор пользователя в системе |
| name | varchar | 50 | “Дмитрий” | Имя пользователя |
| phone | string | 20 | “+7-812-509-65-00” | Номер телефона пользователя |
| email | string | 50 | “example@example.com” | Электронная почта пользователя |
| address | array | - | [{adressid}] | Массив идентификаторов адресов пользователя |
| creationdate | timestamp | - | 1749999076 | Дата и время создания записи пользователя |
| updated | timestamp | - | 1749999076 | Дата и время последнего обновления записи |
